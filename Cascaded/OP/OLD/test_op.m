...
for k = 1:size(z, 1)
    ...
    for j = 1:length(N)
        [k j]
        Gain = general_gain_cascaded(N(j), simulation_params, Nc, simu_gammaBar_c);
        ...
        OP = OP_analit_new(N(j), analit_params, gamma_th, analit_gammaBar_c);
        OP_asy = OP_asymptotic_new(N(j), analit_params, gamma_th, analit_gammaBar_c);
...
legend('' , "$z_1="+num2str(z(1,1))+", z_2="+num2str(z(1,2))+"$", '' , '' , '' , '' , '' , "$z_1="+num2str(z(2,1))+", z_2="+num2str(z(2,2))+"$", '' , '' , '' , '' , '' , "$z_1="+num2str(z(3,1))+", z_2="+num2str(z(3,2))+"$", '' , '' , '' , '' , '' ,  "Non-pointing errors",'Asymptotic', 'Simulated', 'Location', 'southwest')
% legend("Simulated $N="+num2str(N(1))+"$", "Analit $N="+num2str(N(1))+"$", "Simulated $N="+num2str(N(2))+"$", "Analit $N="+num2str(N(2))+"$", "Simulated $N="+num2str(N(3))+"$", "Analit $N="+num2str(N(3))+"$", 'Location', 'southwest')
% legend("Analit $N="+num2str(N(1))+"$","Analit $N="+num2str(N(2))+"$","Analit $N="+num2str(N(3))+"$", "Location", "southwest")

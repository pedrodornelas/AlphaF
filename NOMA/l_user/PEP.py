...
for i in range(len(L)):
    for k in range(len(z)):
        ...
        PEP[:, i, k] = PEP_analit(L[i], l, analit_params, gamma_bar)
        # print(PEP[:, i, k])
        PEP_asy[:, i, k] = PEP_asymptotic(L[i], l, analit_params, gamma_bar)
...
ax.set_ylabel("PEP l^th User: " + str(l))

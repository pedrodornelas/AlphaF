...
def parseArgsToMultiH(params: list[float], L: int, Xi: np.array, points: int) -> np.array:
    Xi = (np.array(Xi))
    # print('------------ XI -------------')
    # print(Xi)
    ...
    a = [[(1-ms, 1), ((z**2)/alpha + 1,1)]] + [[(1-ms,1), (1,1), ((z**2)/alpha + 1,1)]]*(L-1)
    # print('---------------- a ------------------')
    # print(a)
    b = [[(mu, 1), ((z**2)/alpha, 1)]] + [[(mu, 1), ((z**2)/alpha, 1), (0, 1)]]*(L-1)
    # print('---------------- b ------------------')
    # print(b)
    c = [tuple([1]+[alpha/2]*L), tuple([1/2]+[alpha/2]*L)]
    # print('---------------- c ------------------')
    # print(c)
    d = [tuple([0]+[alpha/2]*L)]
    # print('---------------- d ------------------')
